...
int main() {
	...
	glm::mat4 transform3 = glm::mat4(1.0f); // third object transformation 
	...
	while (!glfwWindowShouldClose(window)) {
		...
		transform2 = glm::translate(glm::mat4(1.0f), glm::vec3(0, 0.0f, glm::sin(static_cast<float>(thisFrame)-0.5f)));
		transform3 = glm::translate(glm::mat4(1.0f), glm::vec3(glm::sin(static_cast<float>(thisFrame)), 0.0f, -0.5f));
