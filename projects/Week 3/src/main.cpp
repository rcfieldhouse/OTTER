...
std::string windowTitle = "Ryan Fieldhouse 100784589";
...
int main() {
	...
	static const float interleaved[] = {
		// X	 Y		Z	 R		G	 B
		1.0f, -0.5f, 0.5f, 0.0f, 0.3f, 0.0f,
		1.0f, 0.5f, 0.5f, 0.3f, 0.2f, 0.5f,
	...
	while (!glfwWindowShouldClose(window)) {
		...
		//bind the data in the shaders to the vertex array objects
		...
		glDrawElements(GL_TRIANGLES, (GLenum)interleaved_ibo->GetElementCount(), 
